...
function executeQuery(){
	var sql_query = 'SELECT Name, Npi, PrimaryDepartment, Type FROM ProviderDim';
				...
				if (err1) {
					...
					if(importData.length > 0){
						importData.forEach(function(element,ind) {
							...
							var sqlQuery1 = 'INSERT INTO providers (`name`,`npi`,`type`,`department`) VALUES ("'+displayString+'", "'+element.Npi+'", "'+element.Type+'", "'+element.PrimaryDepartment+'")';
