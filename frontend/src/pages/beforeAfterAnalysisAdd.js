...
class AddBeforeAfterAnalysis extends Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    if (_self.validator.allValid()) {
      ...
      axios
        .post(
          `${
            process.env.REACT_APP_API_BASE_URL
          }before-after-analysis/patientBeforeAfterAdd`,
          payload,
          { params: { session_token: token, user_id: tokenId } }
        )
        .then(res => {
          ...
          <MDBCol md="12">
            <MDBCard>
              <MDBCardHeader color="" tag="h3">
                Add Intervention Before / After Analysis
                <MDBNavLink
                  ...
                  >
                    <MDBRow>
                      ...
                      <MDBCol md="4" className="mb-3">
                        <label htmlFor="reportName" className="grey-text">
                          Name of Report
                        </label>
                        <input
...
export default AddBeforeAfterAnalysis;
