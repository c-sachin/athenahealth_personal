...
import ImagingRow from './imagingRow';
...
class ImagingList extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get(`${process.env.REACT_APP_API_BASE_URL}imaging/imagingList`, {
        params: {
          session_token: token,
          user_id: tokenId,
        },
            ...
            <MDBCard>
              <MDBCardHeader color="" tag="h3">
                ...
                <Link
                  ...
                  to="/createImaging"
                >
                  <i className="fas fa-plus-circle fa-fw" /> Create Imaging
                </Link>
              </MDBCardHeader>
              <MDBCardBody>
                ...
                <MDBTable>
                  ...
                  <MDBTableBody>{this.imagingRow()}</MDBTableBody>
                </MDBTable>
              </MDBCardBody>
            </MDBCard>
          </MDBCol>
