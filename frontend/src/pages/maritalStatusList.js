...
import MaritalStatusRow from './maritalStatusRow';
...
class MaritalStatusList extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_BASE_URL}maritalStatus/maritalStatusList`,
        {
          params: {
            session_token: token,
            user_id: tokenId,
  ...
  genderRow() {
    return this.state.data.map(function(object, i) {
      return <MaritalStatusRow obj={object} key={i} />;
    });
  }
            ...
            <MDBCard>
              <MDBCardHeader color="" tag="h3">
                ...
                <Link
                  ...
                  to="/marital-status-add"
                >
                  <i class="fas fa-plus-circle fa-fw" /> Create Marital Status
                </Link>
              </MDBCardHeader>
              <MDBCardBody>
                ...
                <MDBTable>
                  ...
                  <MDBTableBody>{this.genderRow()}</MDBTableBody>
                </MDBTable>
              </MDBCardBody>
            </MDBCard>
          </MDBCol>
