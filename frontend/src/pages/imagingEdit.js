...
class ImagingEdit extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentDidMount() {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_BASE_URL}imaging/imagingEdit/` +
      ...
      .then(response => {
        ...
        this.setState({
          msg: this.msgBlank,
          imagingName: data[0].imaging_name,
          procedureKey: data[0].procedure_key,
          procedureCode: data[0].procedure_code,
          codeSetType: data[0].code_set_type,
        });
      })
  ...
  handleSubmit = async event => {
    ...
    if (_self.validator.allValid()) {
      ...
      axios
        .post(
          `${process.env.REACT_APP_API_BASE_URL}imaging/imagingUpdate/` +
            this.props.match.params.id,
          obj,
          {
            params: {
              ...
              <MDBCardBody>
                ...
                <div>
                  ...
                  >
                    ...
                    >
                      <i className="fas fa-save fa-fw" /> Update
                    </MDBBtn>
                  </form>
                </div>
              </MDBCardBody>
